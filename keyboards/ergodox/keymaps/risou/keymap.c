...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   ACTION_MODS_KEY(MOD_LGUI, KC_LEFT),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_TILD,KC_EJCT,
       ...
       KC_POWER,KC_0,    KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
                         KC_TRNS,KC_TRNS, KC_PGUP, KC_PGDN, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
/* Keymap 2: Media and mouse keys(default)
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 *                                 `--------------------'       `--------------------'
 */
/* Keymap 2: Media and mouse keys(risou)
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | Rclk | MsUp | Lclk | WhDn |      |           |      | WhDn | Lclk | MsUp | Rclk |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|MsDown|MsRght| WhUp |------|           |------| WhUp |MsLeft|MsDown|MsRght|      |  Play  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      | Lclk | Rclk |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | Lclk | Rclk |                                       |VolUp |VolDn | Mute |      |      |
...
[MDIA] = KEYMAP(
    ...
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_WH_D, KC_BTN1, KC_MS_U, KC_BTN2, KC_TRNS, KC_TRNS,
                 KC_WH_U, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_MPLY,
